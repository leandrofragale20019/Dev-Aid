  ...
  return (
    <div className="color-picker-container">
      ...
      <div className="header-section">
        ...
        <p>
          Test and debug your regular expressions with real-time highlighting.
        </p>
      </div>
      ...
      >
        {/* Pattern Card - Jetzt auch Full Width für die Länge */}
        <div className="card">
        ...
        <div className="card info-card">
          ...
          <div className="card-content">
            <ul className="info-list">
              <li>
                <strong>Global (g):</strong> Highlights all matches in the text.
              </li>
              <li>
                <strong>Case-insensitive (i):</strong> Ignores capital letters.
              </li>
              <li>
                <strong>Multiline (m):</strong> Anchors (^, $) work per line.
              </li>
            </ul>
          </div>
        </div>
